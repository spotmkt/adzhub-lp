/**
 * Lógica compartilhada do sitemap (build local + API dinâmica na Vercel).
 */
...
export const SITE_URL = (process.env.PUBLIC_SITE_URL || "https://adzhub.com.br").replace(/\/$/, "");
...
export async function buildSitemapUrls() {
  ...
  return { urls, postCount: posts.length };
}
