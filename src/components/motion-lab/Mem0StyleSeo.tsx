...
const POSTS = [
  ...
  { title: "Métricas que importam além do tráfego: engajamento e conversão", date: "22 fev 2025", thumb: "from-rose-200 to-pink-300" },
];
...
const PHASES: Phase[] = [
  {
    ...
    description: "Acompanhe cliques, impressões, CTR e posição média no Google a partir do dashboard integrado.",
    view: "dashboard",
    listScrollY: 0,
    highlight: null,
  },
  {
    ...
    description: "Acesse a lista de postagens, filtre por status e encontre rapidamente o artigo que precisa editar.",
    view: "posts",
    listScrollY: 0,
    highlight: "postagens",
  },
  {
    ...
    description: "Role a lista para ver mais artigos organizados por data e status de publicação.",
    view: "posts",
    listScrollY: -120,
    highlight: null,
  },
  {
    ...
    description: "Ajuste título, slug, capa e meta tags. Publique direto no blog com SEO já otimizado.",
    view: "editor",
    listScrollY: 0,
    highlight: "editar",
  },
  ...
  return (
    <div className="p-3 sm:p-4 space-y-3">
      <div className="flex items-center gap-2 text-xs text-muted-foreground mb-2">
        ...
        <span>Voltar para postagens</span>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2 text-[10px]">
        <div>
          ...
          <span className="ml-1 text-foreground">neuromodulacao-fibromialgia</span>
        </div>
        <div>
          <span className="text-muted-foreground">Autor:</span>
          <span className="ml-1 text-foreground">Dr. Silva</span>
        </div>
      </div>
...
function SeoMockInterface({ view, scrollY, highlight }: { view: View; scrollY: number; highlight: "postagens" | "editar" | null }) {
  return (
          ...
          {sidebarApps.map((app, i) => (
            <div
              ...
              className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all ${
                i === CONTENT_ACTIVE_INDEX
                  ? "bg-primary text-primary-foreground"
                  : highlight === "postagens" && i === CONTENT_ACTIVE_INDEX
  ...
  return (
    <section ref={sectionRef} className="relative" style={{ minHeight: sectionMinHeight }}>
      ...
      <motion.div className="sticky top-20 z-10 max-w-7xl mx-auto px-4 sm:px-8">
        <div className="grid lg:grid-cols-[320px_1fr] gap-0 lg:gap-12">
          {/* Stepper */}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        <div className={`text-sm font-semibold transition-colors duration-200 ${isActive ? "text-[#08080C]" : "text-gray-400"}`}>
                          {p.title}
                        </div>
                        <AnimatePresence mode="wait">
                          {isActive && (
