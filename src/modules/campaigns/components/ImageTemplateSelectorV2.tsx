...
interface ImageTemplateSelectorV2Props {
  selectedImageUrl: string | null;
  selectedImageTemplate: ImageTemplate | null;
  onSelectImage: (imageUrl: string | null, template?: ImageTemplate | null) => void;
}

export const ImageTemplateSelectorV2 = ({ selectedImageUrl, selectedImageTemplate, onSelectImage }: ImageTemplateSelectorV2Props) => {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <Label className="flex items-center gap-2 text-dark-primary font-semibold">
          <Image className="h-4 w-4 text-orange-primary" />
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="flex gap-2 text-xs text-muted-foreground">
                          ...
                          <span>•</span>
                          <span>{template.usage_count > 0 ? Math.round((template.response_count / template.usage_count) * 100) : 0}% resp.</span>
                        </div>
                      </div>
                    </div>
