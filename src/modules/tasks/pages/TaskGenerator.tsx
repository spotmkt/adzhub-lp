...
const TaskGenerator = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('user_message', validatedData.text);
      formData.append('user_metadata', JSON.stringify({
        client_id: "cliente",
        user_id: "Usuário",
      }));
      formData.append('callback_url', 'https://xciubsogktecqcgafwaa.supabase.co/functions/v1/receive-task-proposals');
      ...
      // Send to webhook with binary files
