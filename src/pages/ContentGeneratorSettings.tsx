...
const ContentGeneratorSettings = () => {
    ...
    <div className="h-full p-6 bg-background overflow-y-auto">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold">Configurações do Gerador de Conteúdo</h1>
            <p className="text-muted-foreground mt-1">
              Configure como a IA deve criar e gerenciar conteúdo
            </p>
          </div>
        </div>
      ...
      <Dialog open={showAiDialog} onOpenChange={setShowAiDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Insira a URL do site da empresa para que a IA possa analisar e gerar um direcionamento para as big ideas automaticamente.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleGenerateFromWebsite} disabled={generatingAi}>
